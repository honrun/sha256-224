 ...
 */
int32_t mbedtls_sha256_update_ret( mbedtls_sha256_context *ctx, const uint8_t *input, int32_t ilen )
{
    uint32_t fill, left;
    ...
    while( ilen >= 64 )
    {
        if( ( mbedtls_internal_sha256_process( ctx, input ) ) != 0 )
            return -4;
 ...
 */
int32_t mbedtls_sha256_ret( const uint8_t *input, int32_t ilen, uint8_t output[32], int32_t is224 )
{
